...
- **Dependencies:** Capability 1; Decision Dependencies `DEC-DATA-007`, `DEC-ID-003` (open); `DEC-SEC-001`, `DEC-PROV-004` (**CONFIRMED**, 2026-07-30 — see the [Decision Register](../../00-governance/decisions/decision-register.md)).
- **Validation outcome:** not started — `ENG-P2-001`/`ENG-P2-004` are `Blocked` pending the 2 remaining open Decision Dependencies above.
