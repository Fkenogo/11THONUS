...
| Status | Partially implemented — `-02` unblocked (`DEC-PROD-012` CLOSED); pending fresh Founder authorization to begin `-02` | Blocked | Blocked | Blocked |
