...
| P2 | Identity, Roles and Business Context | Identity | **DEC-SEC-001**, **DEC-ID-003**, **DEC-DATA-007**, **DEC-PROV-004** — all `CONFIRMED` (Capability 2 Resolution Sprint, merged to `main` 2026-07-31) | Blocked (the 4 D1 decisions are resolved; blocked on Phase 1 exit determination and Capability Authorisation Gate items `EXT-TECH-001`/`DEC-PROD-012`/`BaseMetadata` conformance — see [Resolution Plan §7](../roadmap/ENG-P2-RES-000-capability-2-resolution-plan.md#7-capability-authorisation-gate)) — Resolution Sprint closed, see [Closure Record](../reports/capability-2-resolution-sprint-closure-record-2026-07-31.md) |
...
| Blocking Reason | DEC-SEC-001, DEC-DATA-007, DEC-PROV-004 now `CONFIRMED` (2026-07-31) — remaining blocker: Phase 1 exit determination + Capability Authorisation Gate items (`EXT-TECH-001`, `DEC-PROD-012`, `BaseMetadata` conformance) | Depends on ENG-P2-001 | Depends on ENG-P2-002 | DEC-ID-003 now `CONFIRMED` (2026-07-31) — remaining blocker: same as ENG-P2-001, plus depends on ENG-P2-001..003 |
