...
| P2 | Identity, Roles and Business Context | Identity | **DEC-SEC-001**, **DEC-ID-003**, **DEC-DATA-007**; ~~**DEC-PROV-004**~~ **CONFIRMED** (2026-07-30 — Approved with Conditions; see Decision Register) | Blocked (depends on P1 + 3 remaining D1 decisions) — Readiness Programme Complete (2026-07-29); Resolution Sprint commenced, see [Resolution Plan](../roadmap/ENG-P2-RES-000-capability-2-resolution-plan.md) |
...
- **Provider Dependencies:** ~~**DEC-PROV-004**~~ (phone OTP delivery route) — **CONFIRMED** (2026-07-30, Approved with Conditions — Firebase-native OTP + Google Sign-In; see [Decision Register](../../00-governance/decisions/decision-register.md)) — resolved, no longer blocks customer authentication.
...
- **Current Status:** Blocked — depends on Phase 1 and 3 remaining D1 decisions. **Capability 2 Readiness Programme Complete** (2026-07-29 — `ENG-P2-000` Readiness Review, `ENG-P2-000A` Governance Reconciliation, and `ENG-P2-000B` Dependency Resolution Analysis all Founder-approved and merged). **Capability 2 Resolution Sprint commenced** (2026-07-29), per the Founder-approved [Capability 2 Resolution Plan](../roadmap/ENG-P2-RES-000-capability-2-resolution-plan.md) (`ENG-P2-RES-000`), beginning with `RES-001 — EXT-TECH-001 Evidence Package`. **Update (`ENG-P2-RES-ADMIN-002`, 2026-07-30):** the first of the four D1 decisions has closed — `DEC-PROV-004` is now `CONFIRMED` (Approved with Conditions, per `RES-002`/`RES-002A`/`RES-002B`). `DEC-SEC-001`, `DEC-ID-003`, and `DEC-DATA-007` remain open; Phase 2 remains `Blocked`.
...
| Provider Dependencies | ~~**DEC-PROV-004**~~ **CONFIRMED** (2026-07-30) | — | — | — |
| Legal Dependencies | — | — | — | — |
| Preconditions | Phase 1 complete; DEC-SEC-001/DATA-007 resolved; DEC-PROV-004 resolved (**CONFIRMED**, 2026-07-30) | ENG-P2-001 complete | ENG-P2-002 complete | ENG-P2-001..003 complete; DEC-ID-003 resolved |
...
| Blocking Reason | DEC-SEC-001, DEC-DATA-007 OPEN; DEC-PROV-004 **CONFIRMED** (resolved, no longer a blocker) | Depends on ENG-P2-001 | Depends on ENG-P2-002 | DEC-ID-003 OPEN_FOUNDER |
