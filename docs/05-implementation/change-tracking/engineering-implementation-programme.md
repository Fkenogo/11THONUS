...
| P2 | Identity, Roles and Business Context | Identity | **DEC-SEC-001**, **DEC-ID-003**, **DEC-DATA-007**, **DEC-PROV-004** | Blocked (depends on P1 + 4 D1 decisions) — Readiness Programme Complete (2026-07-29); Resolution Sprint commenced, see [Resolution Plan](../roadmap/ENG-P2-RES-000-capability-2-resolution-plan.md) |
...
- **Current Status:** Blocked — depends on Phase 1 and 4 D1 decisions (the largest concentration of D1 blockers of any phase). **Capability 2 Readiness Programme Complete** (2026-07-29 — `ENG-P2-000` Readiness Review, `ENG-P2-000A` Governance Reconciliation, and `ENG-P2-000B` Dependency Resolution Analysis all Founder-approved and merged). **Capability 2 Resolution Sprint commenced** (2026-07-29), per the Founder-approved [Capability 2 Resolution Plan](../roadmap/ENG-P2-RES-000-capability-2-resolution-plan.md) (`ENG-P2-RES-000`), beginning with `RES-001 — EXT-TECH-001 Evidence Package`. This is a lifecycle-phase annotation only — the underlying `Blocked` determination and decision dependencies below are unchanged; none of the four D1 decisions has closed.
