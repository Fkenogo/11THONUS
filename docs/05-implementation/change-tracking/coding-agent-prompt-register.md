...
| ENG-P0-002 | P0 | CI pipeline, templates and change-tracking scaffold | FR-OPS-002, FR-OPS-005, FR-OPS-006 | DEC-TECH-004 | In Progress | [Implementation Report](../reports/ENG-P0-002-implementation-report-2026-07-17.md) | — (pending commit on `feat/eng-p0-002-ci-foundation`) | N/A (Phase 0 has no deployment target — see Programme §Phase 0 profile) | N/A (Manual QA Required: No — see Programme §Phase 0 profile) |
