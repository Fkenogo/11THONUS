...
### R2-01 — Master Delivery Workflow current-position/next-action records are stale (Documentation inconsistency, **Medium**) — **[CLOSED / CORRECTED by `ENG-P2-ARCH-CORR-005`, 2026-08-07]**

> **Disposition (2026-08-07, `ENG-P2-ARCH-CORR-005`):** corrected — Master Workflow §7 Phase 1 set to `Complete`; §8/§10 marked superseded historical snapshots; §17 rewritten to the true current position and records that the next governed action is not uniquely established (requires a Founder decision); §19 version-history entry (v1.1) added. Historical text preserved. See the [`ENG-P2-ARCH-CORR-005` implementation report](ENG-P2-ARCH-CORR-005-programme-state-synchronisation-2026-08-07.md).
...
### R2-02 — `CDR-001` represents Customer Identity as "not started / Blocked" despite nine of ten packages merged (Documentation inconsistency, **Medium**) — **[CLOSED / CORRECTED by `ENG-P2-ARCH-CORR-005`, 2026-08-07]**

> **Disposition (2026-08-07, `ENG-P2-ARCH-CORR-005`):** corrected — `CDR-001` §2 (both status tables) qualified and §5 "Validation outcome" rewritten from "not started" to "partially implemented" (nine of ten `ENG-P2-001` packages merged; `-02` gated by open `DEC-PROD-012`; capability remains `Blocked`, not complete/production-ready; Auth/ITM unauthorised; RTM F11 deferred). Header updated. Historical text preserved. See the [`ENG-P2-ARCH-CORR-005` implementation report](ENG-P2-ARCH-CORR-005-programme-state-synchronisation-2026-08-07.md).
