...
Re-validation after fixes: web **322/322** (+3 regression tests over the +15), typecheck/lint/format/build clean, e2e **1/1**, functions **564/564** (untouched). **No unresolved P1/P2 finding remains.** Final reviewed head: `bc23b0e`.
