...
Preserved throughout: the Business designs, owns, and controls its own Reward Program (§11.1); is responsible for accurate communication (§11.2); and 11thONUS does not standardize Reward Program design (§11.4, §14.5). No reward type, amount, threshold, cadence, tier, or min/max value was invented (§11.6). **As corrected on PR #205 review:** §11.1 originally stated that the Business "determines what is rewarded and at what threshold," but this was inaccurate on two points the original authority review missed: `TRD10-firestore-data-architecture.md` §10.9.2's Threshold Rule (MVP) fixes the earning threshold (`requiredVerifiedUnits`) at 10 platform-wide, expressly "not business-configurable"; and the Legal Counsel Handoff Pack §4 lists the general "qualifying-purchase definition" among the questions "not yet Founder-positioned, still genuinely open." §11.1 was rewritten so the Business selects qualifying catalogue categories and its reward within the platform's governed mechanics, with an explicit statement that this section does not authorize altering the platform-fixed threshold and does not resolve the separate open qualifying-purchase-definition question.
