...
Part I (§§1–7) and Part II (§§8–10) clause body text is unchanged from the merged PR #204 baseline. Seven administrative scope-label corrections were made in total (five in the original drafting pass, two added across the `DEC-LEGAL-002-BT-DRAFT-003-CORR-001` PR-review correction rounds): Instrument Map §0.0's readiness-table narrative; Part 0 §0.2 readiness-table rows 5/6/7/11; the "Independence/no-agency" narrative note; §6.2's forward-reference parenthetical; §10.4's forward-reference parenthetical; the Part I heading note (originally missed, corrected on PR #205 review round 1 — see §33/§34 below); and the Part 0 §0.1 Part II architecture label (stale since Part II itself was drafted in task `DEC-LEGAL-002-BT-DRAFT-002` and never corrected until PR #205 review round 3). Each replaces a stale "not drafted in this task"/"remains Part III, not drafted"/"Parts III–VIII remain headings/placeholders only"/"heading only — not drafted" pointer with the correct cross-reference, following the identical precedent PR #204 review finding 4 established when Part II was drafted (correcting stale "Part I only" labels). No clause's legal proposition was altered by any of these seven corrections; a direct diff confirms no other Part I/II text changed.

## 8. §11 clauses drafted

§§11.1–11.6 (Reward Program Responsibility): Business design/control/communication responsibility, selecting qualifying catalogue categories and its reward within the platform's governed catalogue/reward-cycle mechanics — **corrected on PR #205 review to not authorize altering the platform-fixed MVP earning threshold and to not resolve the separate open qualifying-purchase-definition question (see §9 below)**; platform infrastructure role does not make 11thONUS the Reward Program operator/guarantor/fulfiller; Business retains customer-relationship responsibility, no shared/unified loyalty programme; Reward Program rules must not conflict with these Terms; no mandatory reward type/amount/threshold/cadence/tiers/min-max value.

## 9. Business Reward Program control treatment

Preserved throughout: the Business designs, owns, and controls its own Reward Program (§11.1); is responsible for accurate communication (§11.2); and 11thONUS does not standardize Reward Program design (§11.4, §14.5). No reward type, amount, cadence, tier, or min/max value was invented (§11.6). **As corrected across PR #205 review rounds 5–6:** §11.1 originally stated that the Business "determines what is rewarded and at what threshold," but `TRD10-firestore-data-architecture.md` §10.9.2's Threshold Rule (MVP) fixes the earning threshold (`requiredVerifiedUnits`) at 10 platform-wide, expressly "not business-configurable" — a gap the original authority review missed, corrected in both §11.1 and §11.6 (which had separately restated the threshold as Business-controlled). A round-5 correction also added a disclaimer that the general qualifying-purchase-definition question (Legal Counsel Handoff Pack §4) is separately open, but this created an apparent contradiction with the already-approved Part I §6.2, which allocates "what qualifies as a rewardable purchase" to the Business as part of its Reward Program responsibility — a Founder-approved baseline this task does not reopen. §11.1 was corrected in round 6 to cross-reference §6.2's existing allocation directly instead, consistent with the governing instruction not to substantively rewrite §§1–10; Part I §6.2 itself was read and left byte-for-byte unedited.
...
§§13.1–13.7 (Reward Obligations): earned-obligation belongs to the Business, 11thONUS not guarantor/funder/fulfiller; suspension does not extinguish earned rewards, default-redeemable-with-governed-exceptions per `DEC-LOY-011`; exit does not extinguish earned rewards, no invented run-off/cash-settlement period; no retrospective reduction via programme change/suspension/exit; reward-value characterisation preserving FD-6/LEG-FD-04 exactly; **reward expiry preserves the `DEC-LOY-005` CONFIRMED no-automatic-expiry-in-MVP position (corrected on PR #205 review — see §20/§34; Business-level expiry is not authorized by this clause)**; explicit non-resolution of reward quantity/multiple-reward-coexistence, preserving the `DEC-LOY-009` hard boundary.
...
**As corrected on PR #205 review (see §33/§34):** the original wording affirmatively authorized a Business's Reward Program to provide for reward expiry now, which the original authority review missed conflicted with `DEC-LOY-005` (Decision Register, CONFIRMED: earned rewards do not auto-expire in the MVP; the `expired` reward state is architecturally supported but not enabled; future expiry policies possible per program). §13.6 was rewritten to preserve `DEC-LOY-005`'s CONFIRMED position exactly: an earned reward does not currently auto-expire; the schema-supported `expired` state is not enabled under current governance; a Business's Reward Program is not itself authorized by this clause to provide for expiry; any future per-program expiry policy requires separate governed platform authorization. No platform-wide permanent no-expiry rule, mandatory-expiry rule, or minimum/maximum period was invented — the clause states the current CONFIRMED position and the governed path to any future change, nothing more.
...
Three Codex review rounds on PR #205, all findings addressed in task `DEC-LEGAL-002-BT-DRAFT-003-CORR-001` — see the [Correction Report](DEC-LEGAL-002-BT-DRAFT-003-CORR-001-correction-report-2026-08-30.md) for the full disposition of each:

- **Round 1** (head `ef874961a7`, 2 findings): §14.4 originally asserted a no-customer-reacceptance default for Reward Program changes, prematurely deciding a question the Legal Counsel Handoff Pack §4 records as genuinely open — corrected to an explicit non-resolution; the Part I heading note still read "Parts III–VIII remain headings/placeholders only" after Part III was drafted — corrected, inventory count updated to six.
- **Round 2** (head `e7a39d2b40`, requested via `@codex review`, 4 findings): the documentation-changes-log entry required by `README.md` Rule 4 was missing — added (Entries 128, 129); the §11.1 traceability row cited FD-5 for "owns," a proposition FD-5 does not establish — corrected to cite the Legal Counsel Handoff Pack §2 principle instead (the same source Part I §6.1 already cites for identical wording); "three parts" was stale after the Part III bullet made it four — corrected; this report's own §7/§39/§44 still said "five" corrections — corrected to six.
- **Round 3** (head `9ae48745`, requested via `@codex review`, 3 genuinely new findings out of 6 reported — 3 were stale re-flags of already-fixed Round 1/2 items, confirmed by direct inspection of current file content): **(a)** §13.6 affirmatively authorized Business-level reward expiry, but `decision-register.md`'s `DEC-LOY-005` (CONFIRMED) states earned rewards do not auto-expire in the MVP and the `expired` state, while schema-supported, is not enabled — a genuine authority-review gap in the original drafting pass, corrected by rewriting §13.6 to preserve the MVP no-automatic-expiry position and require separate governed authorization before any future per-program expiry policy; **(b)** the Part 0 §0.1 architecture list still labelled Part II "heading only — not drafted," a stale label that predates this task (never corrected when Part II itself was drafted in `DEC-LEGAL-002-BT-DRAFT-002`) — corrected; **(c)** this drafting report's file inventory omitted the correction report itself — corrected.

No new controlled input was created by any correction across all three rounds. `DEC-LOY-005`'s correction (finding 3a) is the one substantive drafting fix in this pass; all others are administrative/citation corrections.
...
- `docs/00-governance/decisions/evidence/DEC-LEGAL-002-BT-DRAFT-001-core-business-terms-draft-2026-08-30.md` (Part III added; seven administrative scope-label corrections to Parts I/II across the original pass and the `-CORR-001` PR-review passes — including a pre-existing stale Part II architecture label first missed when Part II itself was drafted; §14.4 corrected to an explicit non-resolution; §13.6 corrected to preserve the `DEC-LOY-005` CONFIRMED no-automatic-expiry-in-MVP position; header/version metadata updated to v3.1)
- `docs/00-governance/documentation-changes-log.md` (Entry 128 — Part III drafting; Entry 129 — `-CORR-001` PR-review corrections)
- `docs/00-governance/decisions/evidence/DEC-LEGAL-002-BT-DRAFT-001-drafting-traceability-matrix-2026-08-30.md` (Part III clause rows added; §13.6/§11.1/§14.4 rows corrected on PR-review; header/version metadata updated to v3.1)
- `docs/00-governance/decisions/evidence/DEC-LEGAL-002-BT-DRAFT-001-controlled-inputs-register-2026-08-30.md` (Part III review section added; cross-reference note extended; header/version metadata updated to v3.1)
- `docs/00-governance/decisions/decision-register.md` (history entries prepended for `DEC-LEGAL-002-BT-DRAFT-003` and its `-CORR-001` correction pass; full prior history preserved)
- `docs/05-implementation/reports/DEC-LEGAL-002-BT-DRAFT-003-drafting-report-2026-08-30.md` (this report, new file, subsequently corrected — see §33/§34)
- `docs/05-implementation/reports/DEC-LEGAL-002-BT-DRAFT-003-CORR-001-correction-report-2026-08-30.md` (new file, the correction-pass disposition record for all PR #205 review findings)

No other file was modified. The pre-existing untracked files present at task start were not added, modified, or committed.

## 39. Diff summary

Additive: full clause text for §§11–14 (23 numbered sub-clauses across four sections); one new Traceability Matrix table (23 rows) plus a "Part III clauses removed" note; one new Controlled Inputs Register section (Part III review) plus an extended cross-reference note; one new decision-register.md history entry; one new drafting report; one new correction report; two new documentation-changes-log entries (128, 129). Corrective (non-substantive, scope-label only): seven Part I/II forward-reference pointers updated from "not drafted in this task"/"remains Part III, not drafted"/"Parts III–VIII remain headings/placeholders only"/"heading only — not drafted" to the correct cross-reference, across the original drafting pass (five) and the `-CORR-001` PR-review rounds (two). §14.4 was corrected on PR review from an affirmative no-reacceptance default to an explicit non-resolution; §13.6 was corrected to preserve the `DEC-LOY-005` CONFIRMED no-automatic-expiry-in-MVP position. No Part I or Part II clause body text was rewritten beyond these corrections.
...
Full Part III clause-by-clause authority-traceability review completed (§31 above, matrix populated). Prohibited-concept search completed with no asserted-concept matches (§32 above). Parts I–II integrity verified by direct comparison — only the seven documented administrative scope-label corrections found (five in the original pass, two added across the PR-review rounds). `DEC-LOY-009` boundary verified preserved by direct inspection of §13's full text (§21 above). §14.4 verified corrected to an explicit non-resolution and §13.6 verified corrected to preserve `DEC-LOY-005`, both per PR #205 review (§33/§34).
...
**Resolved (previously flagged) pre-existing defect:** already-approved Part I §4.2 previously stated that the earning threshold was "[a] decision the Business makes for its own Reward Program," contradicting `TRD10-firestore-data-architecture.md` §10.9.2's platform-fixed MVP threshold. This task (`DEC-LEGAL-002-BT-DRAFT-003-CORR-001`) discovered and flagged, but did not edit, this defect for lack of Part I authorization. Task `DEC-LEGAL-002-BT-DRAFT-003-CORR-002` received explicit Founder authorization to correct it (along with §6.1 and §6.2) and did so — see that task's [Correction Report](DEC-LEGAL-002-BT-DRAFT-003-CORR-002-correction-report-2026-08-31.md) for the final text and full review-thread reconciliation.
