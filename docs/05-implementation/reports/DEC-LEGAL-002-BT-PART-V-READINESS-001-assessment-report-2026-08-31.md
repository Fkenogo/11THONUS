...
- **(OPTIONAL, non-binding illustration — not required)** That notice must be given of plan or price changes, and that the Business may terminate if a change is not accepted — the *existence* of a notice-and-termination-right structure only, without asserting a specific notice period or standard (corrected this pass; sourced independently from the non-binding External Legal Opinion §20 table/Reconciliation row 20 illustration, **not** from FD-5/LEG-FD-05's Reward-Program-change standard, which remains scoped to Reward Programs and is not independently governed for commercial/subscription/pricing changes — see §11 below for the still-open specific standard).
...
- **(OPTIONAL, non-binding illustration — not required)** That fees are quoted exclusive of taxes and the Business is responsible for applicable taxes, where tax legally applies — a value-independent allocation (corrected this pass from a bare "taxes apply" statement; non-binding External Legal Opinion §20 table illustration, Reconciliation Matrix row 20), without asserting a rate, jurisdiction, or collection mechanism.
- That invoices/receipts exist as a structural billing concept (TRD17 §17.37), without format/timing detail.
- **(OPTIONAL, non-binding illustration — not required)** That accepted payment methods are as specified by 11thONUS on the platform from time to time — a mechanism-agnostic forward-reference, not naming any specific method/provider/rail (corrected this pass from Category D; non-binding External Legal Opinion §20 table illustration, Reconciliation Matrix row 20).
- **(OPTIONAL, non-binding illustration — not required)** That fees are due by a payment deadline, and that reasonable charges or interest may apply for late payment — both as structural concepts only, without a specific day count or rate (added this pass; non-binding External Legal Opinion §20 table illustration, Reconciliation Matrix row 20; the specific values are Category C — see §11).
...
3. **Corrected.** Do **not** state that changes to applicable commercial terms follow the FD-5/LEG-FD-05 Reward-Program-change pattern — on re-inspection, that pattern is not independently governed authority for commercial/subscription/pricing changes (FD-5/LEG-FD-05 are scoped to Reward Programs only; see §8/§11). **Corrected further this pass — this item is optional, not prescriptive.** The drafting task *may, at its discretion*, state that notice must be given of plan or price changes and that the Business may terminate if a change is not accepted — this is the non-binding Legal Opinion §20/Reconciliation row 20 illustration (independent of the rejected FD-5/LEG-FD-05 analogy), available but not required; omitting it entirely is equally acceptable. If included, it must not assert a specific notice period or standard. The exact commercial-change notice standard remains open (see §11) regardless of whether this optional structure is included.
...
6. **Corrected — optional, not prescriptive.** The drafting task *may, at its discretion*, state that fees are quoted exclusive of taxes and the Business is responsible for applicable taxes, where tax legally applies — this is the non-binding Legal Opinion §20/Reconciliation row 20 illustration, available but not required. If included, no rate, jurisdiction, or collection mechanism may be asserted.
7. Explicitly state, following the Part I–IV precedent (e.g., §13.7, §14.4, §17.3), that plan names, prices, currency, billing intervals, **staff limits, trial structure, complimentary/pilot eligibility and terms, proration, grace periods, per-business vs. owner-level billing model, export formats, auto-renewal default, refund policy, the commercial/subscription/pricing-change notice standard,** billing-ownership model, the specific payment-deadline day count, and the specific late-payment charge/interest mechanic — **corrected this pass to state the full §11 Category C inventory verbatim (bolded items added), not a partial list** — are **not decided by this section** and remain governed by the applicable `DEC-SUB-*` decisions and any separately **governed and** communicated commercial terms (corrected this pass — matching item 1's and FD-7's own "separately governed and applicable" formulation; "communicated" alone would let an unresolved value become binding merely by being announced, without the governance FD-7 requires first). This item 7's non-resolution statement applies **regardless** of whether the optional illustrative material in items 3/6 and the payment-method/payment-deadline/late-charge bullets in §10 is included or omitted.
