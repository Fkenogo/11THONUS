...
| Tax treatment | **B** (corrected this pass) | External Legal Opinion §20 Structural Subscription Provisions table ("Taxes — Fees exclusive of taxes; Business responsible"), Reconciliation Matrix row 20, Class A. This is more specific than a bare "taxes where legally applicable" statement — it is a value-independent *allocation* (fees quoted exclusive of tax; Business bears applicable tax), conditional on tax actually applying; no rate/jurisdiction mechanic governed |
...
| Price/plan changes — that notice must be given, and the Business may terminate if a change is not accepted (structural existence, no period/standard) | **B** (corrected this pass) | External Legal Opinion §20 Structural Subscription Provisions table, §C ("Plan changes — 11thONUS may change plans with notice; Business may terminate"; "Price changes — Notice required; Business may terminate if not accepted"), Reconciliation Matrix row 20, Class A — this is *independent* of, and does not rely on, the rejected FD-5/LEG-FD-05 analogy |
