> **Title:** TRD Chapters 1–7 — Platform Architecture  
...
> **Source-of-truth path:** `docs/02-technical/trd/01-07-platform-architecture.md`  
...
> **Domain-model note (Phase 1 consolidation, 16 July 2026):** This chapter originally described twelve domains. The approved final domain model contains **fifteen** domains (TRD Chapter 23 §23.7 and TRD Consolidation Audit §5): Identity, Commerce Knowledge, Rules, **Reward Programs**, Purchase, Loyalty, Reward, Trust, Notification, Reporting, Search, **Subscription**, **Integration**, Administration and Intelligence (future). The three domains previously missing from this chapter are defined below (Domains 13–15), and Administration no longer owns Subscriptions. Where any earlier wording in this chapter conflicts with TRD Chapter 23 §23.7, Chapter 23 governs.
...
Note: Administration provides operational interfaces only. Subscriptions are owned by the dedicated Subscription Domain (Domain 14; TRD Chapter 23 §23.8), and Administration does not own the authoritative business identity record (owned by Identity).
...
*(Added during Phase 1 consolidation per TRD Chapter 23 §23.7–23.8 and TRD Consolidation Audit §5.2.)*

Purpose

Own business-specific Reward Program configuration.
...
Qualifying Product and Service Mappings

Business Display Names

Shared Loyalty-Number Policy

Activation, Pause and Retirement

Commercial Terms

Commerce Knowledge owns the standard classifications; Reward Programs owns the business-specific program configuration built on them. Loyalty owns the Verified Units and Loyalty Cycles that programs generate.

**Domain 14**

**Subscription Domain**

*(Added during Phase 1 consolidation per TRD Chapter 23 §23.7–23.8 and TRD Consolidation Audit §5.4.)*

Purpose

Own commercial subscription records and rules.
...
Subscription Periods and Status

Invoices

Billing Obligations

Administration provides billing support interfaces; Integration owns payment-provider adapters and callbacks.

**Domain 15**

**Integration Domain**

*(Added during Phase 1 consolidation per TRD Chapter 23 §23.7–23.8; fully specified in TRD Chapter 9.)*

Purpose

Exclusive boundary for external providers.
...
Outbound External Requests

Provider References and Status Mapping

Dead-Letter Queues

Notification, Subscription and future Wallet services consume Integration interfaces; they do not own provider adapters.
...
| Reward Programs    | Reward Program identity, versions, commercial configuration | Commerce Knowledge, Rules |
| Purchase           | Purchase Records                | Identity, Rules, Reward Programs     |
| Loyalty            | Verified Units, Loyalty Cycles  | Purchase, Reward Programs            |
| Reward             | Reward Availability, Redemption | Loyalty                              |
| Trust              | Trust Events, Audit             | All domains                          |
| Search             | Discovery                       | Commerce Knowledge                   |
| Notification       | Messaging                       | Reward, Purchase, Integration        |
| Reporting          | Analytics                       | All domains                          |
| Subscription       | Plans, entitlements, subscriptions, invoices, billing obligations | Identity, Integration |
| Integration        | Provider adapters, webhooks, external requests | (consumed by Notification, Subscription) |
...
**Architectural Commitment: Domain-Mirrored Codebase**

One further architectural commitment shapes the entire codebase:

**The codebase shall mirror the platform domains.**
...
Each domain shall contain its own models, services, hooks, Cloud Functions, validation, tests and documentation. This creates strong ownership boundaries, reduces coupling and makes the codebase easier for both human developers and AI coding agents to understand. Combined with the Constitution, PRD and Platform Standards, it gives 11thONUS an enterprise-grade foundation while remaining suited to a Firebase-first implementation.