> **Title:** PRD Section 4 — Customer-Verified Loyalty Engine (CVLE)  
> **Version:** 1.0 · **Status:** Draft for review (pre-freeze) · **Classification:** Authoritative Product  
> **Governing document:** 11thONUS Platform Constitution  
> **Source-of-truth path:** `docs/01-product/prd/04-customer-verified-loyalty.md`  
> **Last controlled update:** 2026-07-16 (Phase 4 — §19 gained IDs FR-CVLE-001..013 per DEC-GOV-006; no wording changed)
...
A business-defined loyalty program.
...
Each program progresses independently.
...
> **ID normalization (Phase 4, 16 July 2026 — DEC-GOV-006):** the 13 requirements below had no IDs at consolidation time (audit finding DOC-P3-008). IDs `FR-CVLE-001..013` were added below in original document order. No requirement wording changed.
...
> **Terminology note (Phase 1 consolidation):** "Trust Ledger" is the product-level concept. It is implemented as the append-only `trustEvents` collection defined in TRD Chapter 10 §10.13. "Ledger" is internal engineering vocabulary and must not appear in customer-facing copy (TRD Chapter 23 §23.9).
...
- Functional Requirements FR-CVLE-001 to FR-CVLE-013 are accepted.
