> **Title:** PRD Section 6 — Reward Programs, Verified Units and Loyalty Cycle Management  
> **Version:** 1.0 · **Status:** Draft for review (pre-freeze) · **Classification:** Authoritative Product  
> **Governing document:** 11thONUS Platform Constitution  
> **Source-of-truth path:** `docs/01-product/prd/06-reward-programs-and-loyalty-cycles.md`  
...
A **Reward Program** is a business-defined loyalty program that specifies:
...
Active (customer-facing label: "Current")
...
> **State-model note (Phase 1 consolidation):** The canonical stored states are `active`, `reward_available`, `reward_redeemed`, `closed` (TRD Consolidation Audit §7.7). "Current" and "Historical" are display labels, not stored states: "Current" corresponds to `active`, and "Historical" describes the reporting view of `closed` cycles.
...
Which programs generate the most On Us Moments.

Which programs generate the highest customer retention.
