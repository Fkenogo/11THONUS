> **Title:** PRD Section 1 — Roles, Permissions and Account Ownership  
> **Version:** 1.0 · **Status:** Draft for review (pre-freeze) · **Classification:** Authoritative Product  
> **Governing document:** 11thONUS Platform Constitution  
> **Source-of-truth path:** `docs/01-product/prd/01-accounts-roles-and-permissions.md`  
> **Last controlled update:** 2026-07-16 (Phase 4 — §18 FR-RP-001..010 renamed to FR-AUTHZ-001..010 per DEC-GOV-006; no wording changed)
...
- reject one purchase at a time, each with its own reason (DEC-LOY-010);
- dispute purchases;
- provide reasons;
...
- create, edit, activate and deactivate Reward Programs;
...
- select an eligible Reward Program;
