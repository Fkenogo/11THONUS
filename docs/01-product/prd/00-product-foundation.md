> **Title:** PRD Stage 1 — Product Foundation  
> **Version:** 1.0 · **Status:** Draft for review (pre-freeze) · **Classification:** Authoritative Product  
> **Governing document:** 11thONUS Platform Constitution  
> **Source-of-truth path:** `docs/01-product/prd/00-product-foundation.md`  
> **Last controlled update:** 2026-07-16 (Phase 3B — §14.3 corrected per DEC-LOY-010: individual rejection confirmed)
...
11thONUS is a Customer-Verified Loyalty Platform, delivered as a cloud-hosted service, designed for small and medium-sized businesses that want to increase repeat visits and recognize loyal customers without requiring a sophisticated Point-of-Sale system.

Businesses subscribe to the platform and create eligible Reward Programs for their recurring products or services. Customers register once and receive a unique loyalty identity that can be used across participating businesses.
...
A business may create a Reward Program that represents:
...
- reject one purchase at a time, providing a reason for that purchase;
- dispute a purchase;
- provide a rejection or dispute reason.

> **Confirmed (Founder decision, 16 July 2026 — DEC-LOY-010):** Rejection is strictly individual. There is no batch or multi-select rejection in 11thONUS; every rejected purchase records its own reason, because different purchases may have different rejection reasons. This aligns this section with TRD Chapter 23 §23.13, which already specified individual, record-specific rejection. This note replaces the Phase 1 editorial note that flagged the two sections as contradictory (audit finding DOC-P1-006).
...
The exact expiry rules will be defined through governed Rules Studio configuration (see TRD Chapter 22, §22.31); default values remain an open decision.
...
- create Reward Programs quickly;
...
- number of active Reward Programs (capacity is counted in Reward Programs, not individual mapped products — see TRD Consolidation Audit §11.1);
...
Between 11 and 20 active Reward Programs.
...
- How many active Reward Programs does a typical business need?
...
| PD-019 | Subscription tiers are initially differentiated largely by active Reward Program limits.     |
