...
> **Status note (Phase 1 consolidation):** The tiers below are **illustrative examples only**. Bronze/Silver/Gold shall not be treated as approved plan names (TRD Consolidation Audit §11.2). Final plan names, staff limits and entitlements are open commercial decisions (TRD Chapter 23, OPD-001 and OPD-002). The platform evaluates plan rules and entitlements rather than plan names.
...
- Required Verified Units *(MVP: fixed at 10 by platform rule and not business-configurable — TRD Consolidation Audit §4; configurability is a future capability)*
- Reward quantity
...
The four operational studios defined below will eventually power the entire platform.
