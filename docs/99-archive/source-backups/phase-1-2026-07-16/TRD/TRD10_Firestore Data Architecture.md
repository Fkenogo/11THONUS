...
| businesses             | Identity / Administration    | Business account and operating identity       |
...
| rewardPrograms         | Loyalty                      | Current Reward Program identity and state     |
| rewardProgramVersions  | Loyalty                      | Historical commercial configuration           |
...
| subscriptions          | Administration               | Business subscription state                   |
| subscriptionPayments   | Administration / Integration | Payment attempt and confirmation              |
| notifications          | Notification                 | Notification intent                           |
| notificationDeliveries | Notification / Integration   | Per-channel delivery attempts                 |
...
countryCode: string;  
timezone: string;  
status: "pending" | "active" | "locked" | "suspended" | "closed";  
createdAt: Timestamp;  
createdBy: string | null;  
updatedAt: Timestamp;  
updatedBy: string | null;  
...
status: "queued" | "processing" | "partially_delivered" | "delivered" | "failed";  
