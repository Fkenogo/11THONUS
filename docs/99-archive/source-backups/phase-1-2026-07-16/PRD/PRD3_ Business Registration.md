...
- maintaining accurate loyalty products.
...
They shall not restrict loyalty products.
...
# 14\. Loyalty Product Creation

Every business must create at least one active loyalty product before recording purchases.

A loyalty product contains
...
Businesses shall create at least one active loyalty product before recording purchases.
...
Businesses shall manage loyalty products.
...
The platform shall prevent purchase recording without an active loyalty product.
...
At least one loyalty product must exist before purchases can be recorded.
...
Businesses define eligible loyalty products.
...
## Loyalty Products and the Loyalty Engine

Rather than simply defining products, it should specify:

- loyalty product lifecycle;
