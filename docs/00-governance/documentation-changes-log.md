...
- **Prerequisites verified:** all nine implementation packages `AUTH-01`–`AUTH-08` (+ `AUTH-CORR-001`/`-002`) merged to `main`, each merge commit CI-green (PRs #87,#88,#89,#90,#91,#92,#94,#95,#96,#97).
