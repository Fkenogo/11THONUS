...
> **Version:** 3.0 (2026-08-30 — Part III drafted, task `DEC-LEGAL-002-BT-DRAFT-003`) · **Status:** DRAFT — NOT APPROVED — NOT EFFECTIVE — NOT CONFIGURED · **Classification:** Working (governance record — controlled legal drafting)
...
14.4 This section does not require a customer to reaccept a Business's Reward Program terms as a condition of a prospective change taking effect, and does not itself establish a reacceptance mechanism. This is without prejudice to any reacceptance requirement that applies to these Terms themselves under a future Changes-to-Terms clause (Part VII §22, not drafted in this task).
