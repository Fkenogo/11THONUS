> **Title:** Core Business Terms — Draft (Instrument Architecture + Part I + Part II + Part III + Part IV)
> **Version:** 4.1 (2026-08-31 — PR #206 review-finding corrections to §16.2 (termination not automatically immediate merely because urgent suspension is available) and §16.4 (run-off arrangement mandatory where necessary), task `DEC-LEGAL-002-BT-DRAFT-004-CORR-001`) · **Status:** DRAFT — NOT APPROVED — NOT EFFECTIVE — NOT CONFIGURED · **Classification:** Working (governance record — controlled legal drafting)
...
- **Part IV — Platform Action, Business Exit and Complaints (§§15–17).** Drafted with full clause text in task `DEC-LEGAL-002-BT-DRAFT-004`. Parts V–VIII remain headings/placeholders only.
...
|---|---|---|
| **A. Core Business Terms** (this document) | 11thONUS ↔ participating Business | Drafting in progress — Part I (Founder-approved baseline), Part II, Part III, and Part IV (draft, pending Founder review) drafted; Parts V–VIII not drafted |
...
*(Drafted with full clause text in task `DEC-LEGAL-002-BT-DRAFT-001` (corrected `-CORR-001`) — the Founder-approved drafting baseline. Part II, §§8–10 below, is now also drafted with full clause text (task `DEC-LEGAL-002-BT-DRAFT-002`, corrected `-CORR-001`), Part III, §§11–14, is now also drafted with full clause text (task `DEC-LEGAL-002-BT-DRAFT-003`), and Part IV, §§15–17, is now also drafted with full clause text (task `DEC-LEGAL-002-BT-DRAFT-004`) — all remain draft pending Founder review. Parts V–VIII remain headings/placeholders only.)*
...
*(Drafted with full clause text in task `DEC-LEGAL-002-BT-DRAFT-003`. Part IV, §§15–17 below, is now also drafted with full clause text (task `DEC-LEGAL-002-BT-DRAFT-004`) — see below. Parts V through VIII remain headings and placeholders only.)*
...
*(Drafted with full clause text in task `DEC-LEGAL-002-BT-DRAFT-004`. Parts V through VIII remain headings and placeholders only — see "End of Part IV" below.)*
...
Parts V through VIII above (§§18–27) remain headings and placeholders only, per the governing task scope. No clause text for those Parts has been drafted, and none should be inferred from Part I, Part II, Part III, or Part IV's treatment of adjacent topics (for example, §17.3's acknowledgement that a Business↔11thONUS complaint mechanism exists in principle does not draft any part of §21's governing-law/arbitration clause, and §15/§16's treatment of suspension and exit does not draft any part of §18's subscription/fees framework or any `DEC-SUB-*` value).

---

## Status Reaffirmation

Drafting this Part I, Part II, Part III, and Part IV document does not change any of the following, all of which remain exactly as they stood before this task:
...
- `DEC-ID-005` = **OPEN_FOUNDER** (owner-initiated business self-suspension — expressly not resolved by §15.7/§16.8)
...
- `DEC-LOY-011` = **CONFIRMED** (reward redemption during business suspension — unchanged; §15.4/§15.5 state this expressly, does not alter it)
