> **Title:** Core Business Terms — Draft (Instrument Architecture + Part I + Part II + Part III + Part IV + Part V)
> **Version:** 5.0 (2026-09-01 — Part V, §18 Subscription and Fees, drafted on the structural Category A/B basis of `DEC-LEGAL-002-BT-PART-V-READINESS-001` as merged/corrected through PR #207, task `DEC-LEGAL-002-BT-DRAFT-005`) · **Status:** DRAFT — NOT APPROVED — NOT EFFECTIVE — NOT CONFIGURED · **Classification:** Working (governance record — controlled legal drafting)
...
- **Part V — Commercial Terms (§18).** Drafted with full clause text, on a structural basis only (no `DEC-SUB-*` value), in task `DEC-LEGAL-002-BT-DRAFT-005`. Parts VI–VIII remain headings/placeholders only.
...
|---|---|---|
| **A. Core Business Terms** (this document) | 11thONUS ↔ participating Business | Drafting in progress — Part I (Founder-approved baseline), Part II, Part III, Part IV, and Part V (draft, pending Founder review) drafted; Parts VI–VIII not drafted |
...
*(Drafted with full clause text in task `DEC-LEGAL-002-BT-DRAFT-001` (corrected `-CORR-001`) — the Founder-approved drafting baseline. Part II, §§8–10 below, is now also drafted with full clause text (task `DEC-LEGAL-002-BT-DRAFT-002`, corrected `-CORR-001`), Part III, §§11–14, is now also drafted with full clause text (task `DEC-LEGAL-002-BT-DRAFT-003`), Part IV, §§15–17, is now also drafted with full clause text (task `DEC-LEGAL-002-BT-DRAFT-004`), and Part V, §18, is now also drafted with full clause text (task `DEC-LEGAL-002-BT-DRAFT-005`) — all remain draft pending Founder review. Parts VI–VIII remain headings/placeholders only.)*
...
*(Drafted with full clause text in task `DEC-LEGAL-002-BT-DRAFT-003`. Part IV, §§15–17 below, is now also drafted with full clause text (task `DEC-LEGAL-002-BT-DRAFT-004`), and Part V, §18, is now also drafted with full clause text (task `DEC-LEGAL-002-BT-DRAFT-005`) — see below. Parts VI through VIII remain headings and placeholders only.)*
...
*(Drafted with full clause text in task `DEC-LEGAL-002-BT-DRAFT-004`. Part V, §18, is now also drafted with full clause text (task `DEC-LEGAL-002-BT-DRAFT-005`) — see below. Parts VI through VIII remain headings and placeholders only — see "End of Part V" below.)*
...
*(Drafted with full clause text in task `DEC-LEGAL-002-BT-DRAFT-005`. Parts VI through VIII remain headings and placeholders only — see "End of Part V" below.)*

### Section 18 — Subscription and Fees

18.1 A Business's participation on the platform may be subject to fees, charges, a subscription plan, or other commercial terms. Where such commercial terms apply to a Business, they are set out separately from these Terms and become binding on that Business only once separately governed and communicated to it. This section does not itself establish any specific plan name, price, currency, billing interval, or other commercial parameter, and does not state that every Business necessarily has an active fee obligation or maintains a paid subscription as a condition of its participation.
