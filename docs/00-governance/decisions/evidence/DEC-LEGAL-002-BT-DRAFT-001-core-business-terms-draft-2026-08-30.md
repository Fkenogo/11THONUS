> **Title:** Core Business Terms — Draft (Instrument Architecture + Part I + Part II + Part III + Part IV + Part V + Part VI)
> **Version:** 6.0 (2026-09-02 — Part VI, §19 Liability and §20 Indemnity, drafted on the bounded basis of `DEC-LEGAL-002-BT-PART-VI-AUTH-001` (merged, PR #209), task `DEC-LEGAL-002-BT-DRAFT-006`) · **Status:** DRAFT — NOT APPROVED — NOT EFFECTIVE — NOT CONFIGURED · **Classification:** Working (governance record — controlled legal drafting)
...
- **Part VI — Risk Allocation (§§19–20).** Drafted with full clause text, on the bounded basis of `DEC-LEGAL-002-BT-PART-VI-AUTH-001` (merged, PR #209), in task `DEC-LEGAL-002-BT-DRAFT-006`. Parts VII–VIII remain headings/placeholders only.
...
|---|---|---|
| **A. Core Business Terms** (this document) | 11thONUS ↔ participating Business | Drafting in progress — Part I (Founder-approved baseline), Part II, Part III, Part IV, Part V, and Part VI (draft, pending Founder review) drafted; Parts VII–VIII not drafted |
...
| 9 | Disputes/corrections | LEG-FD-11, LEG-FD-14 | §17 Complaints and Dispute Facilitation; §21 Governing Law and Dispute Resolution | Partial — §17 drafted in this task (`DEC-LEGAL-002-BT-DRAFT-004`); §21 (Part VII, B2B arbitration mechanics) remains heading only |
...
*(Drafted with full clause text in task `DEC-LEGAL-002-BT-DRAFT-001` (corrected `-CORR-001`) — the Founder-approved drafting baseline. Part II, §§8–10 below, is now also drafted with full clause text (task `DEC-LEGAL-002-BT-DRAFT-002`, corrected `-CORR-001`), Part III, §§11–14, is now also drafted with full clause text (task `DEC-LEGAL-002-BT-DRAFT-003`), Part IV, §§15–17, is now also drafted with full clause text (task `DEC-LEGAL-002-BT-DRAFT-004`), Part V, §18, is now also drafted with full clause text (task `DEC-LEGAL-002-BT-DRAFT-005`), and Part VI, §§19–20, is now also drafted with full clause text (task `DEC-LEGAL-002-BT-DRAFT-006`) — all remain draft pending Founder review. Parts VII–VIII remain headings/placeholders only.)*
...
*(Drafted with full clause text in task `DEC-LEGAL-002-BT-DRAFT-003`. Part IV, §§15–17 below, is now also drafted with full clause text (task `DEC-LEGAL-002-BT-DRAFT-004`), Part V, §18, is now also drafted with full clause text (task `DEC-LEGAL-002-BT-DRAFT-005`), and Part VI, §§19–20, is now also drafted with full clause text (task `DEC-LEGAL-002-BT-DRAFT-006`) — see below. Parts VII through VIII remain headings and placeholders only.)*
...
*(Drafted with full clause text in task `DEC-LEGAL-002-BT-DRAFT-004`. Part V, §18, is now also drafted with full clause text (task `DEC-LEGAL-002-BT-DRAFT-005`), and Part VI, §§19–20, is now also drafted with full clause text (task `DEC-LEGAL-002-BT-DRAFT-006`) — see below. Parts VII through VIII remain headings and placeholders only — see "End of Part VI" below.)*
...
17.3 11thONUS maintains an accessible mechanism through which a Business may raise an operational or platform-related complaint with 11thONUS concerning these Terms or the Business's use of the platform. This section states that such a mechanism exists in principle; it does not itself establish the final Business ↔ 11thONUS dispute-resolution mechanism (including any arbitration forum, seat, rules, or procedure), which is addressed separately under a future Governing Law and Dispute Resolution clause (Part VII §21, not drafted in this task).
...
*(Drafted with full clause text in task `DEC-LEGAL-002-BT-DRAFT-005`. Part VI, §§19–20, is now also drafted with full clause text (task `DEC-LEGAL-002-BT-DRAFT-006`) — see below. Parts VII and VIII remain headings and placeholders only — see "End of Part VI" below.)*
...
*(Drafted with full clause text in task `DEC-LEGAL-002-BT-DRAFT-006`, on the bounded basis confirmed by `DEC-LEGAL-002-BT-PART-VI-AUTH-001` (merged, PR #209) — see that report's §41 (exact permitted drafting scope) and §42 (exact prohibited content). Parts VII and VIII remain headings and placeholders only — see "End of Part VI" below.)*
...
Parts VII and VIII above (§§21–27) remain headings and placeholders only, per the governing task scope. No clause text for those Parts has been drafted, and none should be inferred from Part I, Part II, Part III, Part IV, Part V, or Part VI's treatment of adjacent topics (for example, §19.4's forward reference to the Part VIII jurisdictional-overlay mechanism does not draft any part of §26, and §20 does not restate or draft any part of a future §21 B2B dispute-resolution clause).

---

## Status Reaffirmation

Drafting this Part I, Part II, Part III, Part IV, Part V, and Part VI document does not change any of the following, all of which remain exactly as they stood before this task:
...
- `DEC-ID-005` = **OPEN_FOUNDER** (owner-initiated business self-suspension — expressly not resolved by §15.7/§16.8; §18 does not touch this boundary)
...
- `DEC-LOY-011` = **CONFIRMED** (reward redemption during business suspension — unchanged; §15.4/§15.5 and §18.5 state this expressly, does not alter it)
...
- `CI-01` (operator legal identity) and `CI-05` (reacceptance-on-change engineering decision) = remain the only two open Controlled Inputs, unchanged; §19/§20 do not touch either
