...
| Frozen Domains | Active (1 domain) | §4 — Verified Loyalty only; see [Verified Loyalty Governance Freeze v1.0](verified-loyalty-governance-freeze-v1.md) |
...
| Verified Loyalty Principles | Authoritative (governance) — constitutional reference for the Reward Lifecycle Engine domain | [`verified-loyalty-principles.md`](verified-loyalty-principles.md) |
| Verified Loyalty Governance Freeze v1.0 | Governing (domain freeze declaration) | [`verified-loyalty-governance-freeze-v1.md`](verified-loyalty-governance-freeze-v1.md) |
...
- **Verified Loyalty** (the Reward Lifecycle Engine: Verified Units, Loyalty Cycles, Reward Lifecycle, Reward Expiry, Reward Program Lifecycle, and merchant redemption-support responsibility) — see the [Verified Loyalty Governance Freeze v1.0](verified-loyalty-governance-freeze-v1.md) for the full scope, authoritative hierarchy, and amendment policy. This declaration does not restate that freeze's content and does not alter it.
...
- **Verified Loyalty domain:** fully resolved — `DEC-LOY-008`, `DEC-LOY-009`, `DEC-LOY-013`, `DEC-LOY-014`, `DEC-LOY-015` are all `CONFIRMED`, per the [Verified Loyalty Governance Freeze v1.0](verified-loyalty-governance-freeze-v1.md). No open decision remains within the frozen scope.
...
This is the same process already governing the [Version 1.0 Documentation Declaration](version-1-documentation-declaration.md) §4 and the [Verified Loyalty Governance Freeze v1.0](verified-loyalty-governance-freeze-v1.md) §4 — this document does not introduce a new process, it applies the existing one to the engineering-baseline handover itself.
