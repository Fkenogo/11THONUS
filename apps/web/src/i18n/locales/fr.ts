...
export const fr = {
  ...
  business: {
    ...
    dashboard: {
      nav: {
        ...
        rewardPrograms: "Programmes de fidélité",
        purchases: "Achats",
        customerRewards: "Récompenses clients",
    ...
    rewardProgram: {
      ...
      loadError: "Nous n'avons pas pu charger vos programmes de fidélité. Veuillez réessayer.",
      emptyState: "Aucun programme de fidélité pour l'instant. Créez-en un pour commencer.",
      createAction: "Créer un programme de fidélité",
      createFormTitle: "Nouveau programme de fidélité",
      createSubmit: "Créer le programme",
      editDraftAction: "Modifier le brouillon",
      saveDraftAction: "Enregistrer le brouillon",
      publishAction: "Publier",
      createNextVersionAction: "Créer la version suivante",
      cancel: "Annuler",
    ...
    purchase: {
      title: "Achats",
      subtitle: "Enregistrez les achats des clients et suivez leur vérification.",
      recordTitle: "Enregistrer un achat",
      fieldProgram: "Programme de fidélité",
      fieldArtifactKind: "Identification du client",
      artifactLoyaltyNumber: "Numéro de fidélité",
      ...
      filterLabel: "Statut",
      filterAll: "Tous",
      detailTitle: "Détail de l'achat",
      detailClose: "Fermer le détail",
      recordedBy: "Enregistré par {{role}}",
    ...
    loyaltyVisibility: {
      ...
      loading: "Chargement…",
      loadError: "Impossible de charger ces informations. Veuillez réessayer.",
      notAvailableForRole:
        "Seuls le propriétaire de l'entreprise ou un gérant peuvent consulter les récompenses et la progression des clients.",
      rewardsTitle: "Récompenses prêtes",
      rewardsEmpty: "Aucun client n'a de récompense prête pour le moment.",
      progressTitle: "Progression des clients",
      progressEmpty: "Aucun client n'a encore vérifié d'achat dans un programme de récompenses.",
      ...
      cycleState: {
        active: "En cours",
        reward_available: "Récompense prête",
  ...
  customer: {
    ...
    purchase: {
      waitingTitle: "En attente de vous",
      waitingEmpty: "Rien n'attend votre vérification pour le moment.",
      detailTitle: "Détail de l'achat",
      recordedByBusiness: "Enregistré par cette entreprise",
      ...
      dispute: "Contester",
      disputing: "Envoi…",
      rejectTitle: "Rejeter cet achat",
      rejectHint:
        "Choisissez le motif le plus approprié. Les achats rejetés ne rapportent jamais d'unités.",
      rejectConfirm: "Confirmer le rejet",
      cancel: "Annuler",
      disputeTitle: "Contester cet achat",
      ...
      rejectReason: {
        did_not_happen: "N'a pas eu lieu",
        duplicate: "Doublon",
        wrong_customer: "Mauvais client",
        wrong_program: "Mauvais programme",
        wholly_invalid: "Entièrement invalide",
      },
      disputeReason: {
        wrong_quantity: "Mauvaise quantité",
        wrong_item: "Mauvais article",
        partially_inaccurate: "Partiellement inexact",
      },
      status: {
      ...
      rewardsTitle: "Récompenses disponibles",
      rewardsEmpty: "Vous n'avez encore aucune récompense.",
